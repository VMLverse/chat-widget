...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
	...
	function e(e) {
		e && 3 === e.which || (t(a).remove(), t(o).each(function() {
			...
			a.hasClass("open") && (a.trigger(e = t.Event("hide.bs.dropdown", o)), e.isDefaultPrevented() || (i.attr("aria-expanded", "false"), a.removeClass("open").trigger("hidden.bs.dropdown", o)))
		}))
	}
	...
	s.VERSION = "3.3.4", s.prototype.toggle = function(i) {
		...
		if (/(38|40|27|32)/.test(e.which) && !/input|textarea/i.test(e.target.tagName)) {
			...
			if (e.preventDefault(), e.stopPropagation(), !i.is(".disabled, :disabled")) {
				var a = n(i),
					s = a.hasClass("open");
				if (!s && 27 != e.which || s && 27 == e.which) return 27 == e.which && a.find(o).trigger("focus"), i.trigger("click");
...
function autocompleteResults() {
	$.ui.autocomplete.prototype._renderMenu = function(t, e) {
		var i = this;
		$.each(e, function(e, s) {
			0 === e && t.append('<div id="keyword"><li class="autocompleteHeader">Keyword Suggestions</li></div>'), 5 === e && t.append('<li class="autocompleteHeader">Matching Part Numbers <a href="/search/thorsearch.cfm?search=' + $("#searchBox").val() + '" class="viewAll">view all &raquo;</a></li>'), i._renderItem(t, s)
		})
	}, $.ui.autocomplete.prototype._renderItem = function(t, e) {
		var i = new RegExp(this.term, "i"),
			s = e.label.replace(i, "<span style='font-weight:bold;'>" + this.term + "</span>");
		if ("pagelink" in e) {
			var n = e.partnumber.replace(i, "<span style='font-weight:bold;text-transform: uppercase;'>" + this.term + "</span>"),
				o = "",
				a = "";
			return "Y" == e.obsolete && (o = '<img class="suggOver" style="position: absolute; left:0px; top: 0px; opacity: 0.6;" src="../../images/obsolete/Test.png" >'), "Y" == e.obsolete && (a = "style='opacity: 0.6;'"), $("<li class='matchpnumber'>").data("ui-autocomplete-item", e).append("<div class='searchResultDiv' style='position: relative;'><a class='noUnderline black'><img src='" + e.images + "' class='imgSearch'" + a + ">" + o + n + " - " + s + "</a></div>").appendTo(t)
		}
		return $("<li>").data("ui-autocomplete-item", e).append("<a class='noUnderline black'>" + s + "</a>").appendTo(t)
	}
}! function(t, e) {
	function i(e, i) {
	...
	t.widget("ui.draggable", t.ui.mouse, {
		...
		stop: function(e, i) {
			...
			t.each(s.sortables, function() {
				this.instance.isOver ? (this.instance.isOver = 0, s.cancelHelperRemoval = !0, this.instance.cancelHelperRemoval = !1, this.shouldRevert && (this.instance.options.revert = this.shouldRevert), this.instance._mouseStop(e), this.instance.options.helper = this.instance.options._helper,
	...
	t.widget("ui.selectable", t.ui.mouse, {
		...
		_mouseStart: function(e) {
			...
			this.opos = [e.pageX, e.pageY], this.options.disabled || (this.selectees = t(s.filter, this.element[0]), this._trigger("start", e), t(s.appendTo).append(this.helper), this.helper.css({
				...
				return n ? (s = !e.metaKey && !e.ctrlKey || !n.$element.hasClass("ui-selected"), n.$element.removeClass(s ? "ui-unselecting" : "ui-selected").addClass(s ? "ui-selecting" : "ui-unselecting"),
	...
	t.widget("ui.button", {
		...
		_create: function() {
			...
			null === a.label && (a.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html()), this._hoverable(this.buttonElement), this.buttonElement.addClass(i).attr("role", "button").bind("mouseenter" + this.eventNamespace, function() {
				...
				return a.disabled ? !1 : (t(this).addClass("ui-state-active"), e = this, void s.document.one("mouseup", function() {
					e = null
				}))
...
function(t, e) {
	...
	t.extend(i.prototype, {
		...
		_generateHTML: function(t) {
			var e, i, s, n, o, a, r, h, l, c, u, d, p, f, g, m, v, _, b, y, w, x, k, D, C, I, P, T, M, S, z, A, H, N, E, W, O, F, R, L = new Date,
				...
				tt = t.drawYear;
			if (0 > Z && (Z += 12, tt--), J)
				for (e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - q[0] * q[1] + 1, J.getDate())), e = G && G > e ? G : e; this._daylightSavingAdjust(new Date(tt, Z, 1)) > e;) Z--, 0 > Z && (Z = 11, tt--);
			for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = K ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - $, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>" : U ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = K ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + $, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>" : U ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (Y ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? X : j, a = K ? this.formatDate(a, r, this._getFormatConfig(t)) : a, h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", l = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (Y ? h : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (Y ? "" : h) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), g = this._get(t, "monthNamesShort"), m = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; q[0] > x; x++) {
				for (k = "", this.maxRows = 4, D = 0; q[1] > D; D++) {
					if (C = this._daylightSavingAdjust(new Date(tt, Z, t.selectedDay)), I = " ui-corner-all", P = "", Q) {
					...
					for (P += T + "</tr></thead><tbody>", S = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, S)), z = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, A = Math.ceil((z + S) / 7), H = Q && this.maxRows > A ? this.maxRows : A, this.maxRows = H, N = this._daylightSavingAdjust(new Date(tt, Z, 1 - z)), E = 0; H > E; E++) {
						for (P += "<tr>", W = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(N) + "</td>" : "", w = 0; 7 > w; w++) O = m ? m.apply(t.input ? t.input[0] : null, [N]) : [!0, ""], F = N.getMonth() !== Z, R = F && !_ || !O[0] || G && G > N || J && N > J, W += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (N.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === N.getTime() && b.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (R ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !v ? "" : " " + O[1] + (N.getTime() === X.getTime() ? " " + this._currentClass : "") + (N.getTime() === j.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !v || !O[2] ? "" : " title='" + O[2].replace(/'/g, "&#39;") + "'") + (R ? "" : " data-handler='selectDay' data-event='click' data-month='" + N.getMonth() + "' data-year='" + N.getFullYear() + "'") + ">" + (F && !v ? "&#xa0;" : R ? "<span class='ui-state-default'>" + N.getDate() + "</span>" : "<a class='ui-state-default" + (N.getTime() === j.getTime() ? " ui-state-highlight" : "") + (N.getTime() === X.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + N.getDate() + "</a>") + "</td>", N.setDate(N.getDate() + 1), N = this._daylightSavingAdjust(N);
						P += W + "</tr>"
					}
					Z++, Z > 11 && (Z = 0, tt++), P += "</tbody></table>" + (Q ? "</div>" + (q[0] > 0 && D === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), k += P
				}
				y += k
			}
...
function(t) {
	t.effects.effect.puff = function(e, i) {
		...
		}, "toggle" === e.mode && "show" === p ? (a.from = e.to || b, a.to = e.from || s) : (a.from = e.from || ("show" === p ? b : s),
			a.to = e.to || ("hide" === p ? b : s)), o = {
			from: {
...
$("#searchBox").keyup(function(t) {
	13 == t.keyCode && (window.location.href = "/search/thorsearch.cfm?search=" + $("#searchBox").val())
});

$(".searchButton").click(function() {
	window.location.href = "/search/thorsearch.cfm?search=" + $("#searchBox").val()
});
...
$("#searchBox").autocomplete({
	source: function(t, e) {
		$.ajax({
			url: "/cfc/search/search.cfc?method=autoSuggest&returnformat=JSON&queryformat=column",
			data: {
				keyword: t.term
			},
			success: function(t) {
				t = t.replace("//", ""), t = JSON.parse(t);
				var i = t.T.concat(t.P);
				e($.map(i, function(t) {
					return "OUTPUT" in t ? {
						label: t.OUTPUT,
						value: t.OUTPUT
	...
	select: function(t, e) {
		window.location.href = e.item.pagelink ? e.item.pagelink + "&pn=" + e.item.partnumber : "/search/thorsearch.cfm?search=" + e.item.value
	},
	open: function() {
		$(".matchpnumber").wrapAll('<div id="partNumber">')
	},
	minLength: 3
});
